      ...
      <div className="flex flex-col gap-3 border-t border-neutral-800/60 pt-3">
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            onChange={(e) =>
              handleSliderChange("size", parseInt(e.target.value))
            }
        ...
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            onChange={(e) =>
              handleDynamicsChange("hardness", parseInt(e.target.value) / 100)
            }
            className="w-full accent-blue-500 h-1 bg-neutral-800 rounded appearance-none cursor-pointer"
          />
        </div>
        ...
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            onChange={(e) =>
              handleSliderChange("opacity", parseInt(e.target.value) / 100)
            }
            className="w-full accent-blue-500 h-1 bg-neutral-800 rounded appearance-none cursor-pointer"
          />
        </div>
        ...
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            onChange={(e) =>
              handleDynamicsChange("spacing", parseInt(e.target.value) / 100)
            }
            className="w-full accent-blue-500 h-1 bg-neutral-800 rounded appearance-none cursor-pointer"
          />
        </div>
      ...
      <div className="flex flex-col gap-2 border-t border-neutral-800/60 pt-3">
        ...
        <div className="flex flex-col gap-2 bg-neutral-950/20 p-2 rounded border border-neutral-800">
          <select
            ...
            onChange={(e) =>
              handleStabilizerChange("type", e.target.value as StabilizerType)
            }
        ...
        <div className="flex flex-col gap-1 bg-neutral-950/10 p-1.5 rounded">
          <label className="flex items-center gap-2 text-neutral-400 py-0.5 cursor-pointer">
            <input
              ...
              onChange={(e) =>
                handleDynamicsChange("sizeByPressure", e.target.checked)
              }
          ...
          <label className="flex items-center gap-2 text-neutral-400 py-0.5 cursor-pointer">
            <input
              ...
              onChange={(e) =>
                handleDynamicsChange("opacityByPressure", e.target.checked)
              }
              className="accent-blue-500"
            />
          ...
          <label className="flex items-center gap-2 text-neutral-400 py-0.5 cursor-pointer">
            <input
              ...
              onChange={(e) =>
                handleDynamicsChange("sizeBySpeed", e.target.checked)
              }
              className="accent-blue-500"
            />
